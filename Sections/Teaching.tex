...
\begin{itemize}[leftmargin=*,topsep=10pt,itemsep=1em]
    ...
    \item{\textbf{Introduction to fluid dynamics in water turbines}}
    \begin{description}[nosep, font=\normalfont\itshape]
        % \vspace*{-0.4em}
        \item[Role:] Main teacher and examiner
    ...
    \item{\textbf{Teaching assistant} (Turbomachinery Lab., Turbulent Flows, Introduction to Heat Transfer, Introduction to Fluid Mechanics)}
    \begin{description}[nosep, font=\normalfont\itshape]
        \item[Place:] University of Tehran, Iran
        \item[Level:] Bachelor and Master
        \item[Year:] 2013 -- 2017
    \end{description}
\end{itemize}
\end{multicols}
