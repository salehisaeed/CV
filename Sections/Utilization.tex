% ===============================================
% No forced page break: with the Grant review entry in Academic Service, the
% last Invited Talks item spills onto the next page, and a \newpage here left
% that page holding only those three lines. Harmless in the Zenith proposal,
% whose CV shim neuters \newpage anyway.
% \newpage
