...
% \begin{tabular}{ l c c }
%     \toprule
%     & All & Since 2021 \\ \midrule
%     Citations   & 1281 & 1072 \\
%     $h$-index   & 16   & 15   \\
%     $i$10-index & 23   & 22   \\
%     \bottomrule
% \end{tabular}
% \caption*{Bibliometric information according to \href{https://scholar.google.com/citations?user=6bn6bn0AAAAJ&hl=en}{Google Scholar} (as of July 2026)}
% \end{table}
...
% \centering
% \caption{Contributor Roles Taxonomy (CRediT) of the peer-reviewed journal papers. The reference numbers correspond to those in the previous section (Peer-reviewed Journal Papers).}
% \label{tab:credit}
