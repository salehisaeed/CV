...
\cventry{Researcher}{\href{https://chalmersindustriteknik.se/en/}{Chalmers Industriteknik}, Chalmers University of Technology}{2023 -- 2025}
\begin{cvbody}
Employed by Chalmers Industriteknik (CIT), conducting research on the application of artificial intelligence and machine learning in computational fluid dynamics. During my time at CIT, I was hired by Chalmers University of Technology for a project on ``Artificial Intelligence in Fluid Dynamics for Improving the Lifetime of Hydraulic Turbines''.
\end{cvbody}
